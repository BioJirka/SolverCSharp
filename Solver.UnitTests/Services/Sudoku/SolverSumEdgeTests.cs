...
{
    [TestClass]
    public class SolverSumEdgeTests
    {
        ...
        private SolverSumEdge _solver = new(new List<Coordinates> {
            new Coordinates { Row = 1, Col = 1, Direction = "S", Number = 4 }, 
            new Coordinates { Row = 1, Col = 1, Direction = "E", Number = 12 }
            }, _rowCnt, _colCnt);
        ...
        [TestMethod]
        public void BanInitial_Void_BanHighValuesNextTo4AndLowValuesNextTo12()
        {
            _solver.BanInitial(_gridMethod, _rowCnt, _colCnt, _numRange);
            _gridManual.Fields[0, 0].Bans = new bool[_numRange] { true, true, false, true, true, true, true, true, true };
            _gridManual.Fields[0, 0].BanCnt = 8;
            _gridManual.Fields[0, 1].Bans = new bool[_numRange] { true, true, false, false, false, false, false, false, false };
        ...
        [TestMethod]
        public void Ban_SetValue3InSumCorner_SetValuesNextToSumTo1And9()
        {
